...
export function TermsPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      <Helmet>
        <title>Terms of Use — Smart Marina Connect</title>
      </Helmet>
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="bg-white rounded-xl shadow-sm border p-6 md:p-10 space-y-8 text-gray-700 leading-relaxed">
          ...
          <section className="border-t pt-6">
            <p className="text-sm text-gray-500">For any questions regarding these Terms, please contact: <a href="mailto:contact@smartmarinaconnect.com" className="text-primary hover:underline">contact@smartmarinaconnect.com</a></p>
          </section>
        </div>
      </div>
    </div>
