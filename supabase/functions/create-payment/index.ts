...
const LYRA_SHOP_ID = Deno.env.get('LYRA_SHOP_ID') || '69876357';
const LYRA_API_PASSWORD = Deno.env.get('LYRA_API_PASSWORD') || 'testpassword_DEMOPRIVATEKEY23G4475zXZQ2UA5x7M';
